...
function App() {
  ...
  return (
    <>
      <div className="lg:flex lg:flex-row lg:gap-x-5 lg:pl-14 lg:pr-14 lg:pt-5 lg:justify-around md:hidden ">
        {/* time section */}
      ...
      <div className="lg:hidden md:flex md:flex-col md:p-5 md:gap-4">
